...
var messages = map[string]map[string]string{
	"fa": {
		...
		"btn_confirm_join":     "عضو شدم ✓",
		"btn_trial":            "اکانت تست",
		"btn_help":             "راهنما",
		"btn_wallet_history":   "تاریخچه کیف پول",
		"help_default":         "برای شروع /start را بزنید.",
		"wallet_history_title": "تاریخچه تراکنش‌ها:",
		"trial_disabled":       "اکانت تست فعال نیست.",
		"trial_already_used":   "شما قبلاً از اکانت تست استفاده کرده‌اید.",
		"trial_no_plan":        "پلن تست موجود نیست.",
	},
	"en": {
		...
		"btn_confirm_join":     "I joined ✓",
		"btn_trial":            "Free trial",
		"btn_help":             "Help",
		"btn_wallet_history":   "Wallet history",
		"help_default":         "Send /start to open the main menu.",
		"wallet_history_title": "Recent transactions:",
		"trial_disabled":       "Trial accounts are not enabled.",
		"trial_already_used":   "You have already used your trial.",
		"trial_no_plan":        "No trial plan available.",
	},
}
